...
omlistsd = document.getElementsByTagName("li");

omlistsd = document.querySelector("ul").getElementsByTagName("li");

let lisArr = Array.from(omlistsd);
lisArr.forEach(function (item) {
  console.log(item);
});

console.log(omlistsd);
...
let domval;
let omlists = document.querySelector("ol");
...
//Get Child Nodes
domval = omlists;
domval = omlists.childNodes;
domval = omlists.childNodes[0];
domval = omlists.childNodes[1];
domval = omlists.childNodes[1].nodeName;
domval = omlists.childNodes[1].nodeType;
domval = omlists.childNodes[0].nodeType;
// 1 Element
// 2 Attribute
// 3 Text Node
// 8 Comment
...
domval = omlists.children;
domval = omlists.children[2];
domval = omlists.children[2].children[0];
domval = omlists.children[2].children[0].href;

domval = omlists.firstElementChild;
domval = omlists.lastElementChild;
domval = omlists.childElementCount;
